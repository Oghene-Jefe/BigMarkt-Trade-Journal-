...
const properties = [
  ...
  },
  {
    domain: "bigmarkt.co",
    title: "The Protocol",
    desc: "Where it all connects. Architecture, $BMT token, ecosystem coordination, and governance.",
    does: ["Architecture docs", "$BMT settlement", "Ecosystem coordination", "Governance"],
    href: "/",
  },
];
