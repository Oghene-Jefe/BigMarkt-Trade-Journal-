    ...
    <footer className="border-t border-[#1f1f1f] bg-[#0a0a0a] px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-white/60">Academy</h4>
          ...
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-white/60">Community</h4>
            <div className="mt-4">
              <SocialLinks />
            </div>
          </div>
        ...
        <div className="mt-12 border-t border-[#1f1f1f] pt-8">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4">
            <Link href="/privacy" className="text-xs text-white/60 hover:text-white/90">Privacy Policy</Link>
            <p className="text-xs text-white/60">© 2026 Free Trading Academy. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
