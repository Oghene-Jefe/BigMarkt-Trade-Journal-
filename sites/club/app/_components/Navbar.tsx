      ...
      {open && (
        <>
          <div
            ...
            onClick={() => setOpen(false)}
          />
          <aside id="mobile-menu" className="fixed right-0 top-16 bottom-0 z-50 flex w-72 max-w-[80vw] flex-col gap-1 border-l border-[#1f1f1f] bg-[#0a0a0a] px-6 py-6 md:hidden">
            {links.map((l) => (
              <Link
                key={l.href}
                href={l.href}
