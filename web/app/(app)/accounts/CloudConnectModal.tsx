...
export default function CloudConnectModal() {
  ...
  const inputCls =
    "w-full rounded-md border border-white/10 bg-bg px-3 py-2 text-sm text-white";
          ...
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg border border-white/10 bg-panel p-6">
            ...
            {done ? (
              <div className="space-y-4">
                <div className="rounded-md border border-win/30 bg-win/10 p-4 text-sm text-win">
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="max-h-44 overflow-y-auto rounded-md border border-white/10 bg-bg">
                    {filtered.length === 0 ? (
